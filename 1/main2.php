...
<div class="list-group">
  ...
  <a href="datos_personales/datos_personales.php" class="list-group-item"><button type="button" class="btn btn-default btn-lg"><img src="../icons/apps/preferences-contact-list.png"  class="img-reponsive img-rounded"> Mis Datos</button></a>
  </div>
  
  <!-- Trigger the modal button LogIn-->
      <button type="button" class="btn btn-default btn-lg" data-toggle="modal" data-target="#myModal"><img src="../icons/places/server-database.png"  class="img-reponsive img-rounded"> Iniciar Lotes</button>
  ...
  <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        <a data-toggle="collapse" href="#collapse2"><button type="button" class="btn btn-default btn-lg"><img src="../icons/apps/accessories-dictionary.png"  class="img-reponsive img-rounded"> Documentación</button></a>
      </h4>
    </div>
