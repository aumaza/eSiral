...
<html><head>
  <title>Generar Archivo de Lote</title>
...
<div class="panel panel-info" >
  ...
  <div class="input-group">
    ...
    <input id="text" type="text" minlength="3" class="form-control" name="nro_lote" placeholder="Ingrese nro. de Lote" onkeyup="this.value=Numeros(this.value);" onKeyDown="limitText(this,3);" onKeyUp="limitText(this,3);" required>
    </div>
    </div>
    </div>
    </div>
	     ...
	     if (isset($_POST['A'])) {
			    ...
			    $cod_org = mysqli_real_escape_string($conn,$_POST["cod_org"]);
                            ...
                            $nro_lote = mysqli_real_escape_string($conn,$_POST["nro_lote"]);
                             ...
                             genLoteDP($cod_org,$cod_arch,$nro_lote,$nombre,$conn);
