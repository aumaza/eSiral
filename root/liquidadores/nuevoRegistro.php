...
<div class="panel panel-info" >
  ...
  <div class="input-group">
    ...
    <input id="text" type="text" class="form-control" name="nombre" placeholder="Nombre y Apellido" value="" onkeyup="this.value=Text(this.value);" required>
  </div>
  ...
  <div class="input-group">
   ...
   <div class="input-group">
    ...
    <input  type="email" maxlenght="20" class="form-control" name="email" placeholder="E-Mail" onKeyDown="limitText(this,20);" onKeyUp="limitText(this,20);" required>
  </div>
  <div class="input-group">
