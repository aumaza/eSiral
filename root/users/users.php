...
<div class="navbar-header">
  ...
  <a class="navbar-brand"><span class="pull-center "><img src="../../icons/actions/meeting-attending.png"  class="img-reponsive img-rounded"><strong> Usuarios </strong></a>
</div>
...
<!-- Links -->
    <ul class="nav navbar-nav navbar-right">
      <li class="active" ><a href="nuevoRegistro.php">Nuevo Registro <span class="pull-center "><img src="../../icons/actions/list-add.png"  class="img-reponsive img-rounded"></a></li>
    </ul>
<!-- Search -->
</div>
</div>
