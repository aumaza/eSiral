...
<div class="navbar-header">
  ...
  <a class="navbar-brand"><span class="pull-center "><img src="../../icons/actions/view-bank.png"  class="img-reponsive img-rounded"><strong> Organismos </strong></a>
</div>
...
<!-- Links -->
    <ul class="nav navbar-nav navbar-right">
      <li class="active" ><a href="nuevoRegistro.php">Ingresar Organismo <span class="pull-center "><img src="../../icons/actions/list-add.png"  class="img-reponsive img-rounded"></a></li>
    </ul>
<!-- Search -->
</div>
</div>
